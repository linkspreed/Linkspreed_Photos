# <img align="left" alt="Linkspreed Photos" width="100px" src="https://photos.linkspreed.com/favicon/icon-144x144.png" draggable="false" /> Linkspreed Photos ([Click to try 🚀](https://photos.linkspreed.com/)) - Decentralized (Web3) | (v3.0.8)
...
## Features
 ...
 - **SaaS mode** – Use Linkspreed Photos for free and get 200 terabytes of free cloud storage on your account.
 - **High Performance** – Linkspreed Photos is lightweight and has lighting fast performance and page load time out of the box.
 ...
 - **Translations** – Linkspreed Photos is fully translation ready and can be easily translated to any language.
 - **Responsive** – Linkspreed Photos is fully responsive and will work on desktop, mobile, tablet and other devices.
 - **Dark Mode** – Linkspreed Photos comes with pre-built light and dark themes. You can fully customize them or add new themes via appearance editor.
